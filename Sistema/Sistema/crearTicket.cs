...
namespace Sistema
{
    class crearTicket
    {
        ...
        public void EncabezadoVenta()
        {
            ...
            linea.AppendLine("PRODUCTO               |SERVICIO         |PRECIO");
        }

        public void EncabezadoProductoCliente()
        {
            //Escribimos los espacios para mostrar el articulo. En total tienen que ser 40 caracteres
            linea.AppendLine("PRODUCTO               |CODIGO ");
        }
        ...
        public void AgregarPedido(string articulo,string cant, decimal precio)
        {
            //Valida que cant precio e importe esten dentro del rango.
            if (cant.ToString().Length <= 30 && precio.ToString().Length <= 11)
            {
                string elemento = "", espacios = "";
                bool bandera = false;//Indicara si es la primera linea que se escribe cuando bajemos a la segunda si el nombre del articulo no entra en la primera linea
                int nroEspacios = 0;
        ...
        public void Reimprimir(string articulo, string cant, string precio)
        {
            //Valida que cant precio e importe esten dentro del rango.
            if (cant.ToString().Length <= 30 && precio.ToString().Length <= 11)
            {
        ...
        public void ImprimirTicketProductoCliente(string articulo, string codigo, string idcliente)
        {
            //Valida que cant precio e importe esten dentro del rango.
            if (codigo.ToString().Length <= 30 && idcliente.ToString().Length <= 11)
            {
                string elemento = "", espacios = "";
                bool bandera = false;//Indicara si es la primera linea que se escribe cuando bajemos a la segunda si el nombre del articulo no entra en la primera linea
                int nroEspacios = 0;
                ...
                {
                    //Colocar la cantidad a la derecha.
                    nroEspacios = (7 - codigo.ToString().Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += "        ";//Generamos los espacios necesarios para alinear a la derecha
                    }
                    elemento += espacios + codigo.ToString();//agregamos la cantidad con los espacios

                    //Colocar el precio a la derecha.
                    nroEspacios = (20 - idcliente.ToString().Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += "       ";//Genera los espacios
                    ...
                    //el operador += indica que agregar mas cadenas a lo que ya existe.
                    elemento += espacios + idcliente.ToString();//Agregamos el precio a la variable elemento
                ...
                else //Si no es mayor solo agregarlo, sin dar saltos de lineas
                {
                    ...
                    //Colocar la cantidad a la derecha.
                    nroEspacios = (7 - codigo.ToString().Length);// +(20 - elemento.Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += "";
                    }
                    elemento += espacios + codigo.ToString();

                    //Colocar el precio a la derecha.
                    nroEspacios = (5 - idcliente.ToString().Length);
                    espacios = "            ";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += "";
                    }
                    elemento += espacios + idcliente.ToString();
    ...
    public class RawPrinterHelper
    {
        ...
        public static bool SendBytesToPrinter(string szPrinterName, IntPtr pBytes, Int32 dwCount)
        {
            ...
            di.pDocName = "Document XPS";//Este es el nombre con el que guarda el archivo en caso de no imprimir a la impresora fisica.
