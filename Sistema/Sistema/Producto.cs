...
namespace Sistema
{
    class Producto
    {
       ...
       /* public Producto(int folio, int id, string codigo, string descripcion, string nombreempresa, decimal costo, decimal precio, decimal cantidad, string cliente, string vendedor, float saldo, float total, float cambio)*/
        public Producto(int folio, int id, string codigo, string descripcion, string nombreempresa, decimal costo, decimal precio, decimal cantidad, string cliente,string vendedor)
        {
            this.folio = folio;
            this.id = id;
            this.codigo = codigo;
